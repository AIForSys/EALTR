...
for p in range(1, 21):
            ...
            for dir in dirs:
                ...
                for root, dirs, files, in os.walk(dir_path):
                    ...
                    for j in range(len(Ltr_linear_pred)):
                            ...
                            LTR_pred.append(Ltr_linear_pred[j]*testingcodeN[j])



                    Precisionx, Recallx, F1x, IFMA, PMI, recallPmi,PofB,PofBPmi = PerformanceMeasure(testing_data_y, LTR_pred,
                                                                                            testingcodeN, 0.2,
                                                                                        'density',
                                                                                        'loc').Performance()
    ...
    result_csv_name ="NewEALTR_pofb_testing_20220503_"+str(p)+".xlsx"
